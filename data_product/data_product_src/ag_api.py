...
# E.g., in the dest data below the result of get_value("Turing", "email") will be: "turing@mail.com"^^<http://www.w3.org/2001/XMLSchema#anyURI>
# this should strip out the datatype and extra string characters so will return turing@mail.com
