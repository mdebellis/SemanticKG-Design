...
#   Uses deliberately oversized UI text so cropped screenshots remain readable
#   when placed on presentation slides. Query and application logic are unchanged.
#
# Assumptions:
...
#   streamlit run C:\Users\mdebe\Documents\GitHub\SemanticKG-Design\data_product\data_product_src\ui_streamforge_chatbot_askmydocuments_for_presentation.py
# ------------------------------------------------------------

st.set_page_config(layout="wide")

# ------------------------------------------------------------
# Presentation-only font sizing
#
# Main title and subheaders are intentionally left at Streamlit's normal sizes.
# Everything else is enlarged for slide screenshots.
# ------------------------------------------------------------
PRESENTATION_CSS = """
<style>
/* Normal prose / markdown, including the generated answer. */
...
/* Info boxes shown before results are available. */
...
/* Best-effort enlargement for the Citation Trace grid. */
